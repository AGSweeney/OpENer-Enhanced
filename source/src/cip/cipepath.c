...
void SetPathPortSegmentPortIdentifier(const unsigned int port_identifier,
  ...
  (*cip_path) = (unsigned char)(*cip_path | (unsigned char)port_identifier);
}
...
unsigned int GetPathPortSegmentExtendedPortNumber(
  ...
  return (unsigned int)cip_path[kExtendedPortSegmentPosition] +
         ((unsigned int)cip_path[kExtendedPortSegmentPosition + 1] << 8);
}
...
void SetPathPortSegmentExtendedPortIdentifier(
  ...
  cip_path[kExtendedPortSegmentPosition] =
    (CipOctet)(extended_port_identifier & 0x00FFU);
  cip_path[kExtendedPortSegmentPosition +
           1] = (CipOctet)( (extended_port_identifier & 0xFF00U) >> 8 );
}
/*** Port Segment ***/
