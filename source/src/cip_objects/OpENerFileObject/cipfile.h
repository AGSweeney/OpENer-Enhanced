...
static const EipUint8 kCipFileObjectInitiateUploadServiceCode = 0x4BU;
static const EipUint8 kCipFileObjectUploadTransferServiceCode = 0x4FU;
static const EipUint8 kCipFileObjectInitiateDownloadServiceCode = 0x4CU;
static const EipUint8 kCipFileObjectDownloadTransferServiceCode = 0x50U;
static const EipUint8 kCipFileObjectClearFileServiceCode = 0x51U;
...
typedef EipStatus (*CipFileDeleteInstanceDataFunction)(
...
typedef struct cip_file_object_values {
  ...
  CipFileDeleteInstanceDataFunction delete_instance_data;
